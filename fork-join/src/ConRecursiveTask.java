            ...
            try (Scanner scanner = new Scanner(file)) {
                while (scanner.hasNextLine()) {
                    ...
                    if (shouldSplit()) {
                        ...
                        FileProcessingTask leftTask = new FileProcessingTask(tempFile1);
                        FileProcessingTask rightTask = new FileProcessingTask(tempFile2);

                        // Invoke the subtasks recursively
                        leftTask.fork();
                        rightTask.fork();
